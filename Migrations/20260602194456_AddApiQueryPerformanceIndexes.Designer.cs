...
namespace ESCOLA_API.Migrations
{
    ...
    [Migration("20260602194456_AddApiQueryPerformanceIndexes")]
    partial class AddApiQueryPerformanceIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ESCOLA_API.Models.CadernetaDigital", b =>
                {
                    ...
                    b.HasIndex("IdAlunoUsuario", "IdTurmaEnsino", "IdDisciplina");
            ...
            modelBuilder.Entity("ESCOLA_API.Models.Notificacao", b =>
                {
                    ...
                    b.HasIndex("IdUsuario", "CriadaEmUtc");

                    b.HasIndex("IdUsuario", "Lida");
